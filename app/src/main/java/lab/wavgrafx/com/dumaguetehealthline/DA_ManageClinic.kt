...
import kotlinx.android.synthetic.main.activity_da__manage_clinic.*
import lab.wavgrafx.com.dumaguetehealthline.model.ClinicModel

class DA_ManageClinic : AppCompatActivity() {

    lateinit var mAuth: FirebaseAuth
    lateinit var rootRef: DocumentReference
    private var adapter: DA_ManageClinic.ClinicFirestoreRecyclerAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_da__manage_clinic)
    ...
    private inner class ClinicViewHolder internal constructor(private val view: View) : RecyclerView.ViewHolder(view) {
        internal fun setClinicDetails(FName: String, MName: String, LName: String, Gender: String, Degree: String, Practice: String,
                                      ...
                                      Break1end: String, Break2start: String, Break2end: String, MaxPat:String, AllowedBookDays:String, Creator: String) {
            ...
            view.setOnClickListener {
                val intent = Intent(this@DA_ManageClinic, DA_ClinicSettings::class.java)
